...
#'
#' Returns the composite cost-of-borrowing indicator for house purchase loans
#' in the euro area or a specific country.
#'
...
ecb_mortgage_rates <- function(country = "U2", from = NULL, to = NULL,
                               cache = TRUE) {
  cli::cli_progress_step("Fetching mortgage rate data")
  key <- paste0("M.", country, ".B.A2C.AM.R.A.2250.EUR.N")
